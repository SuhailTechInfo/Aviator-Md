 ...
 **/
  ...
  ╰━━━━━━━━━━━━━━⊷\n`
   ...
   //str += `╰━━━━━━━━━━━───⊷\nsᴜʜᴀɪʟ ᴛᴇᴄʜ ɪɴғᴏ \n www.youtube.com/c/SuhailTechInfo`
              return await Aviator.sendMessage(msg.chat, { image: { url: THUMB_IMAGE }, caption: str + Config.caption ,footer: tlang().footer, headerType: 4 })
          }
      )
      //---------------------------------------------------------------------------
  sᴜʜᴀɪʟ_ᴍᴅ.cmd({
      ...
      async(Aviator, msg) => {
          ...
          return await Aviator.sendMessage(msg.chat, buttonMessaged, {   quoted: msg, });
  ...
  async(Aviator, msg, text ,{isCreator }) => {
   if(!isCreator) return msg.reply("*Ahh Sorry, Only Owner Can Use This Cmd*")
   ...
   let arr = [];
          ...
          if (!cmd) return await msg.reply("*❌No Such commands.*");
