...
try { Levels.setURL(mongodb); console.log("🌍 Connected to the Suhail Tech Bot DB");} 
catch(e){ console.log("Could not connect with Mongodb please provide accurate uri check video for more inofo❗\nhttps://youtu.be/7YWI50BDO5op"); process.exit(0); }
...
setTimeout(() => {
    ...
    async function syncdb() {
        ...
        Aviator.client = VoidConnect({
            ...
            browser: ['ᴀᴠɪᴀᴛᴏʀ-ᴍᴅ', 'safari', '1.0.0'],
